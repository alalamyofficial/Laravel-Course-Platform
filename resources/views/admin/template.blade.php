        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link  {{(request()->is('admin/dashboard')) ? 'active' : ''}}" href="{{route('admin.dashboard')}}">
              ...
              <span class="{{route('admin.dashboard')}}">Dashboard</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link  {{(request()->is('admin/categories')) || (request()->is('admin/create/category')) ? 'active' : ''}} " href="{{route('admin.categories')}}">
              ...
              <span class="{{route('admin.categories')}}">Categories</span>
            </a>
          </li>
          @endif
          ...
          <li class="nav-item">
            <a class="nav-link {{(request()->is('admin/ratings')) ? 'active' : ''}}" href="{{route('admin.ratings')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>credit-card</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <li class="nav-item">
            <a class="nav-link  {{(request()->is('admin/plans')) || (request()->is('admin/create/plan')) ? 'active' : ''}} " href="{{route('admin.plans')}}">
              ...
              <span class="{{route('admin.plans')}}">Plans</span>
            </a>
          </li>
          @endif
          ...
          @if(auth()->user()->role_as == 10)      
          <li class="nav-item">
            <a class="nav-link  {{(request()->is('admin/subscriptions')) || (request()->is('admin/create/subscription')) ? 'active' : ''}} " href="{{route('admin.subscriptions')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>office</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="{{route('admin.subscriptions')}}">Subscriptions</span>
            </a>
          </li>
          @endif
          ...
          <li class="nav-item">
            <a class="nav-link  {{(request()->is('admin/settings')) ? 'active' : ''}} " href="{{route('admin.settings')}}">
              ...
              <span class="{{route('admin.settings')}}">Settings</span>
            </a>
          </li>
          @endif
          ...
          <li class="nav-item">
            <a class="nav-link  {{(request()->is('admin/comments')) ? 'active' : ''}} " href="{{route('admin.comments')}}">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>office</title>
                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <span class="{{route('admin.comments')}}">Comments</span>
            </a>
          </li>
