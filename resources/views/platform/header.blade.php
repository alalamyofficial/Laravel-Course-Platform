<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="{{asset('site_assets/img/fav.png')}}" />
  <!-- Author Meta -->
  ...
  <!--
      ...
      =============================================
    -->
  <link rel="stylesheet" href="{{asset('site_assets/css/linearicons.css')}}" />
  <link rel="stylesheet" href="{{asset('site_assets/css/font-awesome.min.css')}}" />
  <link rel="stylesheet" href="{{asset('site_assets/css/bootstrap.css')}}" />
  ...
  <link rel="stylesheet" href="{{asset('site_assets/css/nice-select.css')}}">
  <link rel="stylesheet" href="{{asset('site_assets/css/hexagons.min.css')}}" />
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/videojs-hotkeys/0.2.27/videojs.hotkeys.js" integrity="sha512-M9iK6FRA9GXG6xM8Q2a05AMzEJJeRIPy43lSq4N23Ht/HVo6q3vKAHadBLKYmTyUZIdqpQZHKZjaWFGX6EZ0sA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
